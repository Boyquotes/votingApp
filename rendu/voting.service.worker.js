...
const CACHE_NAME = "voting-cache";
const OFFLINE_URL = "voting.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["voting.html","voting.js","voting.wasm","voting.pck","voting.offline.html","voting.icon.png","voting.apple-touch-icon.png"];
